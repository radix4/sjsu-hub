        ...
        <Container fluid style={backgroundColor}>
            ...
            <Row className = 'd-flex align-items-center'>
                <Col sm = {7}>
                    ...
                    <Col style={firstRow}>
                        <Button style ={{"margin": "5px"}} variant="outline-primary" size = "lg">Register</Button>
                        <Button variant="outline-primary" size = "lg">Login</Button>
                    </Col>
                    <Col style={secondRow}>
                        <Button style ={{"margin": "5px"}} variant="outline-primary">Group Chat</Button>
                        <Button style ={{"margin": "5px"}} variant="outline-primary">Internships and Jobs</Button>
